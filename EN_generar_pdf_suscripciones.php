...
try {
    ...
    $pdf->Cell(0, 10, 'Subscription Report - HomeSafe', 0, 1, 'C');
    $pdf->Ln(5);
    ...
    $header = ['Email', 'Phone Number', 'Subscribed Date', 'Expiration Date', 'Paypal ID Transaction', 'Subscription Type'];
    ...
    $pdf->Output('subscription_report.pdf', 'D');

} catch (Exception $e) {
    error_log("Error generating PDF: " . $e->getMessage());
    echo "A general error has ocurred: " . $e->getMessage();
    exit;
}
?>