...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Eliminar Repartidores<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <div class="form">
                <h1 class="login-title">Eliminar Repartidores</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        $query = "SELECT id, nombre, telefono, email, estado, fecha_registro FROM repartidores";
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>" . htmlspecialchars($row['fecha_registro'], ENT_QUOTES, 'UTF-8') . "</td>";


                                echo "<td>";
                                echo "<form method='post' action='backend_rep_delete.php'>";
                            ...
                            echo "<tr><td colspan='6'>No hay repartidores disponibles</td></tr>";
                        }
                        ...
                        <script>
                            function confirmDelete(formElement) {
                                Swal.fire({
                                    title: "¿Estás seguro de eliminar este repartidor?",
                                    text: "Una vez eliminado, no podrás recuperar este repartidor.",
                                    icon: "warning",
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            text: "El repartidor no se ha eliminado",
                                            icon: "warning"
                                        })
                                    }
                                });
