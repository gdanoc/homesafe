...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Usuarios</h1>
                ...
                <!-- Información de registros y controles -->
            ...
            <div class="pdf-download">
                <a href="generar_pdf_usuario.php" class="btn btn-primary" target="_blank">
                    <i class="fas fa-file-pdf"></i> Descargar PDF de Usuarios
                </a>
            </div>
