...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['pago_paypal'])) {
    ...
    if (empty($direccion)) {
        echo '<script>
            swal({
                title: "Error",
                text: "La dirección no puede estar vacía o contener caracteres inválidos.",
                icon: "warning",
                button: "Cerrar",
            });
        </script>';
    ...
    if (!preg_match('/^\d{4}-\d{4}$/', $telefono_sin_espacios)) {
        echo '<script>
            swal({
                title: "Error",
                text: "El teléfono debe tener el formato XXXX-XXXX, solo números y un guion.",
                icon: "warning",
                button: "Cerrar",
            });
        </script>';
    ...
    if ($latitud === null || $longitud === null || $latitud < 13.148 || $latitud > 14.445 || $longitud < -90.128 || $longitud > -87.692) {
        echo '<script>
            swal({
                title: "Error",
                text: "La ubicación seleccionada no está dentro de El Salvador",
                icon: "warning",
                button: "Cerrar",
            });
        </script>';
    ...
    if (empty($direccion) || empty($telefono) || $latitud === null || $longitud === null) {
        echo '<script>
            swal({
                title: "Error",
                text: "Por favor completa todos los campos y selecciona una ubicación en el mapa",
                icon: "warning",
                button: "Cerrar",
            });
        </script>';
        ...
        try {
            ...
            try {
                ...
                $body .= '
                            ...
                            <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; text-align: center;">
                                ...
                                <p style="margin-bottom: 15px; color: #666;">
                                    <strong>📞 Servicio al cliente:</strong> homesafe2025contact@gmail.com
                                </p>
                                <p style="color: #666;">
                        ...
                        <div class="footer">
                            ...
                            <p style="font-size: 12px; margin-top: 15px;">
                                © 2025 HomeSafe. Todos los derechos reservados.
                            </p>
                        </div>
                    </div>
                </body>
                ...
                $mail->Body = $body;
                $mail->AltBody = "Gracias por tu compra en HomeSafe. Total: $total. Dirección: $direccion. Teléfono: $telefono. Método de pago: PayPal. ID transacción: $paypal_transaction_id.";
                $mail->send();
            } catch (Exception $e) {
                
                error_log("Error al enviar correo de factura: " . $mail->ErrorInfo);
            }
            ...
            echo '<script>
                swal({
                    ...
                    text: "Tu pedido no se pudo procesar",
                    icon: "warning",
                    button: "Cerrar",
                }).then(function() {
                    window.location = "mostrarcarrito.php";
...
<head>
    <title>Finalizar Compra - HomeSafe</title>
                                    ...
                                    <div class="profile-container">
                                        ...
                                        <div class="profile-info">
                                            ...
                                            <div class="profile-info-item">
                                                ...
                                                <p><a href="pedidosusuario.php">Ver Pedidos</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section class="section novi-background section-md text-center">
            <div class="container">
                <h3 class="text-uppercase font-weight-bold wow-outer">
                    <br>
                    <span class="wow slideInDown">Finalizar compra</span>
                </h3>
                <div class="row">
                    <div class="col-lg-8">
                        <div class="checkout-container">
                            ...
                            <form method="post" action="">
                                ...
                                <div class="mb-2">
                                    <h>Correo Electrónico</h>
                                    <label class="form-label"></label>
                                    <p><?php echo htmlspecialchars($_SESSION['email']); ?></p>
                                </div>
                                <div class="mb-3">
                                    <label for="ubicacion_guardada">Selecciona una ubicación guardada:</label>
                                ...
                                <div class="map-container">
                                    <h5 class="mb-3">Selecciona tu dirección de envío</h5>
                                    <div class="map-instructions">
                                        <i class="fas fa-info-circle"></i>
                                        <strong>Instrucciones:</strong> Haz clic en el mapa para seleccionar tu dirección de envío. El marcador se colocará en la ubicación seleccionada.
                                    </div>
                                    <div id="map"></div>
                                ...
                                <script>
                                            ...
                                            .then(data => {
                                                if (data && data.address) {
                                                    ...
                                                    if (countryCode === 'sv' || country === 'El Salvador') {
                                                        ...
                                                        return {
                                                            valid: false,
                                                            message: `Esta ubicación está en ${country}. Solo se permiten direcciones en El Salvador.`
                                                        };
                                                    }
                                                } else {
                                                    return {
                                                        valid: false,
                                                        message: "No se pudo verificar la ubicación. Por favor selecciona un punto más específico."
                                                    };
                                                }
                                            })
                                            .catch(error => {
                                                ...
                                                return {
                                                    valid: false,
                                                    message: "Error al validar la ubicación. Por favor intenta nuevamente."
                                                };
                                            });
                                    }
                                        ...
                                        map.on('click', function(e) {
                                            ...
                                            if (!isInElSalvador(lat, lng)) {
                                                swal({
                                                    ...
                                                    text: "La ubicación seleccionada está fuera de los límites de El Salvador.",
                                                    icon: "warning",
                                                    button: "Entendido",
                                                });
                                                return;
                                    ...
                                    document.getElementById('ubicacion_guardada').addEventListener('change', function() {
                                        ...
                                        if (!val) {
                                            ...
                                            document.getElementById('selected-address').textContent = 'Haz clic en el mapa para seleccionar una dirección';
                                            document.getElementById('direccion').value = '';
                                            document.getElementById('latitud').value = '';
                                            document.getElementById('longitud').value = '';
                                            document.getElementById('coordinates').textContent = 'No seleccionadas';
                                            return;
                                        }
                                        ...
                                        paypal.Buttons({
                                            ...
                                            createOrder: function(data, actions) {
                                                ...
                                                return actions.order.create({
                                                    purchase_units: [{
                                                        description: 'Compra en HomeSafe',
                                                        amount: {
                                                            currency_code: 'USD',
                                            ...
                                            onError: function(err) {
                                                ...
                                                swal({
                                                    title: "Error en el pago o rellene los datos",
                                                    text: "Hubo un problema al procesar tu pago con PayPal. Por favor intenta nuevamente.",
                                                    icon: "error",
                                                    button: "Cerrar",
                                                });
                                            }
                        ...
                        <div class="order-summary">
                                ...
                                <div class="product-list mb-4">
                                    <?php foreach ($productos as $producto): ?>
                                        <div class="product-item d-flex align-items-center py-2">
                                            <img src="data:image/jpeg;base64,<?php echo base64_encode(pg_unescape_bytea($producto['imagen'])); ?>" alt="<?php echo htmlspecialchars($producto['nombre']); ?>" class="product-img me-3">
                            ...
                            <?php else: ?>
                                <div class="alert alert-warning">
                                    ...
                                    <a href="furniture.php" class="alert-link">Ir a comprar</a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
