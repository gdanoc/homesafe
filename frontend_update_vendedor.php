...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Modificar Propiedades<i class="page-tittle"></i></span>
                            </a>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Modificar Propiedades</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>";
                                echo "<form method='post' action='backend_update_vendedor.php'>";
                            ...
                            echo "<tr><td colspan='7' style='text-align: center;'>No hay propiedades disponibles para este vendedor</td></tr>";
                        }
            ...
            <script>
                ...
                document.getElementById('mainImages').addEventListener('change', function(e) {
                    ...
                    <button type="button" class="remove-image" title="Eliminar imagen" onclick="removeMainImage(${index})">
