...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-right">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                <a class="dropdown-item" href="EN_logout.p.php"><i
        ...
        <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="EN_usuarios_lista.php" style="text-decoration:none;">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <a href="EN_propiedades_lista.php" style="text-decoration:none;">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="box card-hover bg-gradient-blue text-center">
                                    ...
                                    <h6 class="text-white">Earnings</h6>
                                    <h3 class="text-white">$<?php echo number_format($gananciasEntregadas, 2); ?></h3>
                                </div>
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6">
                                <a href="EN_pedidos_entregados.php" style="text-decoration:none;">
            ...
            <script>
                const labels = ['Furniture', 'Orders', 'Users', 'Properties'];
                const data = {
                    labels: labels,
                    datasets: [{
                        label: 'Total',
