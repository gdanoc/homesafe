...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             <span class="d-none d-md-block">Delete Furniture<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <div class="form">
        <h1 class="login-title">Delete Furniture</h1>
        <table>
            <thead>
                <tr>
                    <th>Name</th>
...
$query = "SELECT id, nombre, descripcion, precio, cantidad, descuento, fecha, imagen FROM muebles";
...
if (pg_num_rows($result) > 0) {
    ...
    while ($row = pg_fetch_assoc($result)) {
        echo "<tr>";
        echo "<td>" . tr(htmlspecialchars($row['nombre'], ENT_QUOTES, 'UTF-8')) . "</td>";
        echo "<td>" . tr(htmlspecialchars($row['descripcion'], ENT_QUOTES, 'UTF-8')) . "</td>";
    ...
    echo "<tr><td colspan='8'>There is no furniture</td></tr>";
}
...
?>                <script>
                    function confirmDelete(id) {
                        swal({
                            title: "Are you sure to delete this furniture?",
                            ...
                            if (willDelete) {
                                ...
                                window.location.href = 'EN_backend_delete.php?id=' + id;
                            } else {
                                swal("The furniture have not deleted.");
                            }
                        });
                    }
                </script>
