...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Usuarios<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Suscripciones</h1>
                <table id="tablaSuscripciones" border="1" cellpadding="5" cellspacing="0">
                    <thead>
                        <tr>
                            <th>Email</th>
                            <th>Teléfono</th>
                            <th>Fecha Suscrito</th>
                            <th style="cursor:pointer;" onclick="sortTableByDate(3)">Fecha Vencimiento &#x25B2;&#x25BC;</th>
                    ...
                    <tbody>
                        ...
                        if ($result && pg_num_rows($result) > 0) {
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                $tipo_suscripcion = isset($planes[$row['plan_id']]) ? $planes[$row['plan_id']] : 'Sin suscripción';
                                echo "<td class=\"$plan_td_class\"><span class=\"plan-underline\">" . htmlspecialchars($tipo_suscripcion) . "</span></td>";

                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='6'>No hay suscripciones registradas.</td></tr>";
                        }
            ...
            <div class="pdf-download">
                <a href="generar_pdf_suscripciones.php" class="btn btn-primary" target="_blank">
                    <i class="fas fa-file-pdf"></i> Descargar PDF de Suscripciones
                </a>
            </div>
