...
try {
    ...
    $query_total = "SELECT COUNT(*) FROM pedidos WHERE estado = 'entregado'";
    ...
    if (!$result) {
        throw new Exception("Error al ejecutar la consulta de pedidos: " . pg_last_error($conn));
    }
...
<head>
    ...
    <title>Pedidos Entregados - HomeSafe</title>
    <!-- Custom CSS -->
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Pedidos Entregados<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Pedidos Entregados</h4>
                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Pedidos Entregados</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Email</th>
                    ...
                    <tbody>
                        ...
                        if ($result && pg_num_rows($result) > 0) {
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                $pedido_id = $row['id'];
                                $query_asignacion = "SELECT r.nombre FROM asignaciones_entrega a
                                ...
                                if ($repartidor_asignado) {
                                    echo "<td>" . htmlspecialchars($repartidor_asignado['nombre']) . "</td>";
                                } else {
                            ...
                            echo "<tr><td colspan='9' style='text-align:center; padding: 15px;'>No hay pedidos entregados disponibles.</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
            ...
            <div class="pdf-download">
                <a href="generar_pdf_entregados.php" class="btn btn-primary" target="_blank">
                    <i class="fas fa-file-pdf"></i> Descargar PDF de Pedidos Entregados
                </a>
            </div>
