...
$count_query = "SELECT COUNT(*) FROM muebles";
...
$query = "SELECT nombre, descripcion, precio, cantidad, fecha, imagen, descuento FROM muebles ORDER BY fecha DESC LIMIT $limit OFFSET $offset";
...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Dashboard <i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Furniture List</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        if ($result && pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars(tr($row['nombre'])) . "</td>";
                                echo "<td>" . htmlspecialchars(tr($row['descripcion'])) . "</td>";
                                ...
                                $imagen = $row['imagen'];
                                $datos_imagen = pg_unescape_bytea($imagen);
                                echo "<td><img src='data:image/jpeg;base64," . base64_encode($datos_imagen) . "'width='100' height='100'/></td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='7'>There is no furniture</td></tr>"; 
                        }
                        ?>
                    </tbody>
                </table>
