...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             <span class="d-none d-md-block">Delete Delivery People<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <div class="form">
        <h1 class="login-title">Delete Delivery People</h1>
        <table>
            <thead>
                <tr>
                    <th>Name</th>
...
if (pg_num_rows($result) > 0) {
    ...
    while ($row = pg_fetch_assoc($result)) {
        ...
        echo "<td>" . tr(htmlspecialchars($row['estado'], ENT_QUOTES, 'UTF-8')) . "</td>";
    ...
    echo "<tr><td colspan='6'>No delivery people</td></tr>";
}
...
?>                <script>
                    function confirmDelete(id) {
                        swal({
                            title: "Are you sure to delete this delivery person?",
                            ...
                            if (willDelete) {
                                ...
                                window.location.href = 'EN_backend_rep_delete.php?id=' + id;
                            } else {
                                swal("The delivery person has not deleted.");
                            }
                        });
                    }
                </script>
