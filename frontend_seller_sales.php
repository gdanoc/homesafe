...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Lista de propiedades vendidas<i class="page-tittle"></i></span>
                            </a>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Lista de Ventas</h1>
                <div style="overflow-x: auto;">
                    <table>
                        ...
                        <tbody>
                            ...
                            if (pg_num_rows($result) > 0) {
                                ...
                                echo "<tr><td colspan='7' style='padding: 20px; text-align: center; background-color: #f8d7da; color: #721c24; border-radius: 8px; border: 1px solid #f5c6cb;'>No tienes ventas de propiedades registradas.</td></tr>";
                            }
                    ...
                    <div class="pdf-download">
                        <a href="generar_pdf_seller.php" class="btn btn-primary" target="_blank">
