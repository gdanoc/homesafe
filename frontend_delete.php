...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Eliminar Muebles<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <div class="form">
                <h1 class="login-title">Eliminar Muebles</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>";
                                echo "<form method='post' action='backend_delete.php'>";
                            ...
                            echo "<tr><td colspan='8'>No hay muebles disponibles</td></tr>";
                        }
                        ...
                        <script>
                            function confirmDelete(formElement) { 
                                swal({
                                    ...
                                    text: "Una vez eliminado, no podrás recuperar este mueble.",
                                    icon: "warning",
                                    ...
                                    if (willDelete) {
                                        ...
                                        swal("El mueble no ha sido eliminado.");
                                    }
                                });
                            }
                        </script>
