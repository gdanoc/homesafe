...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Eliminar Propiedades<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Eliminar Propiedades</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>";
                                echo "<form method='post' action='backend_delete_vendedor.php'>";
                                echo "<div class='propiedad-actions'>";
                                echo "<input type='hidden' name='id' value='" . htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8') . "'>";
                                echo "<button type='button' class='delete-button' onclick='confirmDelete(this.form)'>Eliminar</button>";
                                echo "</div>";
                                echo "</form>";
                                echo "</td>";
                                echo "</tr>";
                        ...
                        <script>
                            function confirmDelete(formElement) {
                                Swal.fire({
                                    ...
                                    text: "Una vez eliminada, no podrás recuperar esta propiedad.",
                                    icon: "warning",
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            text: "La propiedad no se ha eliminado",
                                            icon: "warning"
                                        })
                                    }
                                });
