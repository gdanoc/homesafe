    ...
    <section class="section novi-background section-md text-center">
        <div class="container">
            <h3 class="text-uppercase font-weight-bold wow-outer">
                <br>
                <span class="wow slideInDown">Favorite Properties</span>
            </h3>
            <br>
            <div class="propiedades-grid">
                ...
                if (!$conn) {
                    ...
                    if (count($propiedades) > 0) {
                            ...
                            <div class="propiedad-card">
                                ...
                                <div class="propiedad-content">
                                    ...
                                    <div class="propiedad-info">
                                        ...
                                        <span>🛁 Bathrooms: <?php echo htmlspecialchars($row['bathrooms']); ?></span>
                                    </div>
                                    <div class="propiedad-info">
                                ...
                                <form method="post" action="EN_single_property.php">
                                    <div class="propiedad-actions">
                                        <?php if ($row['estado'] == "Vendido"): ?>
                                            <a class="btn-vendido button button-md button-primary button-winona wow slideInDown">Solg Out</a>
                                        <?php else: ?>
                        ...
                        echo '<div class="col-12 text-center py-5"><h4>You have no properties in your favorites</h4></div>';
                    }
                    pg_close($conn);
                }
                ?>
        ...
        if (result.success) {
            if (isFavorited) {
                ...
                if (document.querySelectorAll('.propiedad-card').length === 0) {
                    ...
                    grid.innerHTML = '<div class="col-12 text-center py-5"><h4>You have no properties in your favorites</h4></div>';
                }
            } else {
