        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="reviewModalLabel">Add Review to <span id="reviewFurnitureName"></span></h5>
                ...
                <div class="modal-body">
                    <form id="reviewForm">
                        ...
                        <div class="form-group text-center">
                            <label for="rating" class="d-block mb-2">Your Rating:</label>
                        ...
                        <div class="form-group">
                            <label for="comment">Message (máx. 255 characters):</label>
                    ...
                    <div class="rd-navbar-aside-outer">
                        <div class="rd-navbar-aside">
                            ...
                            <div class="rd-navbar-panel">
                                ...
                                <!-- RD Navbar Brand--><a class="rd-navbar-brand" href="EN_index.php"><img src="images/logo-default-151x44.png" alt="" width="151" height="44" srcset="images/logo-default-151x44.png 2x" /></a>
                            </div>
        ...
        <section class="search-section">
            <div class="search-container">
                <div class="search-input-wrapper">
                    ...
                    <input type="text" id="searchInput" placeholder="Search furniture by name..." onkeyup="searchFurniture()" autocomplete="off">
...
LIMIT 3";
        ...
        <?php if (pg_num_rows($popular_result) > 0): ?>
            <section class="section novi-background section-md text-center" style="background-color: #f8f9fa; padding: 60px 0;">
                <div class="container">
                    ...
                    <p class="text-muted mb-5">The furniture most highly rated by our customers</p>
                            ...
                            <div class="col-md-6 col-lg-4 wow-outer mb-4">
                                <article class="post-modern popular-item wow fadeIn">
                                    ...
                                    <h4 class="post-modern-title">
                                        <?php echo htmlspecialchars(tr($popular_row['nombre']), ENT_QUOTES, 'UTF-8'); ?>
                                    </h4>
                                    ...
                                    <p style="font-size: 14px; color: #666;">Available: <?php echo htmlspecialchars($popular_row['cantidad'], ENT_QUOTES, 'UTF-8'); ?> units</p>
                                    ...
                                    <a href="javascript:void(0);" onclick="<?php echo ($popular_row['cantidad'] == 0) ? 'noStockAlert(); return false;' : "addToCart({$popular_row['id']}, document.getElementById('popular-quantity-{$popular_row['id']}').value, {$popular_row['cantidad']})"; ?>" class="btn btn-primary btn-sm">
                                        <i class="fa fa-shopping-cart"></i> <span class="btn-text">Add to Shopping cart</span>
                                    </a>
                                </article>
                            </div>
                        <?php endwhile; ?>
                    ...
                    <div class="mt-4">
                        <p style="color: #666; font-style: italic;">
                            ...
                            Selected products based on the best ratings from our customers
                        </p>
                    </div>
                </div>
            </section>
        ...
        <section class="section novi-background section-md text-center">
            <div class="container">
                <h3 class="text-uppercase font-weight-bold wow-outer">
                    <br>
                    <span class="wow slideInDown">Available Furniture</span>
                </h3>
                <div class="row row-lg-50 row-35 offset-top-2">
                            ...
                            <div class="col-md-4 col-lg-3 wow-outer" style="padding-top: 8px; padding-bottom: 20px; margin-bottom: 10px;">
                                <article class="post-modern wow fadeIn" style="padding: 12px; border: 2px solid #444; border-radius: 10px; text-align: center; max-width: 280px; margin: 0 auto; transition: all 0.3s ease; box-shadow: 0 4px 8px rgba(0,0,0,0.1); position: relative; top: 0;" onmouseover="this.style.top='-5px'; this.style.boxShadow='0 8px 16px rgba(0,0,0,0.2)';" onmouseout="this.style.top='0'; this.style.boxShadow='0 4px 8px rgba(0,0,0,0.1)';">
                                    ...
                                    <div style="position: relative; display: inline-block;">
                                        <?php if ($descuento_valor > 0) : ?>
                                            <div class="discount-badge-top">
                                                <i class="fa fa-arrow-down"></i> Discounted Product
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if (isset($_SESSION['email'])) : ?>
                                            ...
                                            <button type="button" onclick="event.stopPropagation(); openReviewModal(<?php echo $row['id']; ?>, '<?php echo htmlspecialchars(tr($row['nombre']), ENT_QUOTES, 'UTF-8'); ?>');" class="review-btn" data-toggle="tooltip" data-placement="top" title="Click to add a review" style="position: absolute; bottom: 8px; left: 8px; background-color: #212529; color: #FFC107; border: 2px solid #FFC107;">
                                                <i class="fa fa-star"></i>
                                            </button>
                                        <?php endif; ?>
                                    </div>
                                    <h4 class="post-modern-title" style="margin-top: 10px; font-size: 17px; font-weight: bold;">
                                        <?php echo tr(htmlspecialchars(tr($row['nombre']), ENT_QUOTES, 'UTF-8')); ?>
                                    </h4>
                                    ...
                                    <?php } else { ?>
                                        <div class="average-rating-container" style="display: flex; align-items: center; justify-content: center; gap: 5px; margin: 8px 0;">
                                            <span style="font-size: 12px; color: #999; font-style: italic;">No reviews yet</span>
                                        </div>
                                    <?php } ?>
                                    ...
                                    <?php endif; ?>
                                    <p style="font-size: 14px;">Stock: <?php echo htmlspecialchars($row['cantidad'], ENT_QUOTES, 'UTF-8'); ?></p>
                                    <p style="font-size: 12px; color: #666; margin-top: 5px; max-height: 60px; overflow: hidden;">
                                        <?php echo htmlspecialchars(tr($row['descripcion']), ENT_QUOTES, 'UTF-8'); ?>
                                    </p>
                                    <div class="form-group" style="margin-bottom: 10px;">
                                        <label for="quantity-<?php echo $row['id']; ?>" style="font-size: 14px;">Stock:</label>
                    ...
                    <?php }
                        ...
                        echo '<div class="col-12 text-center py-5"><h4>There are no furniture</h4></div>';
                    }
                    ?>
                </div>
            </div>
        ...
        <footer class="section novi-background footer-advanced bg-gray-700">
            ...
            <div class="footer-advanced-aside">
                <div class="container">
                    <div class="footer-advanced-layout">
                        <a class="brand" href="EN_index.php">
    ...
    <script>
        ...
        function addToCart(id, quantity, availableQuantity) {
            ...
            if (quantity > availableQuantity) {
                Swal.fire("You cannot add more units than are available.", "", "warning");
                return;
            }

            fetch('EN_addcarrito.php?id=' + id + '&quantity=' + quantity, {
                    method: 'GET',
                ...
                .then(data => {
                    if (data.status === 'success') {
                        ...
                        Swal.fire(data.message || "Error adding to cart", "", "error");
                    }
                })
                .catch(() => {
        ...
        function noStockAlert() {
            Swal.fire("You cannot add this product to your cart because there are no more units available.", "", "warning");
        }
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4) {
                    ...
                    if (xhr.status === 200) {
                        ...
                        resultsContainer.innerHTML = '<div class="no-results">Connection error</div>';
                    }
                }
            };
        ...
        function displaySearchResults(results) {
            ...
            if (results.length > 0) {
                ...
                resultsContainer.innerHTML = '<div class="no-results"><i class="fa fa-search"></i> No furniture found</div>';
            }
            ...
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
                    ...
                    if (details.avg_rating && details.total_reviews > 0) {
                        ...
                        document.getElementById('furnitureName').innerHTML = details.nombre + '<br><div style="margin-top: 10px; font-size: 12px; color: #999; font-style: italic;">No reviews yet</div>';
                    }
        ...
        function openReviewModal(muebleId, furnitureName) {
            <?php if (!isset($_SESSION['email'])) : ?>
                Swal.fire('You must log in to add a review.', '', 'warning');
                return;
            <?php endif; ?>
        ...
        function submitReview() {
            ...
            if (comment.trim() === '') {
                Swal.fire('Please write a message for your review.', '', 'warning');
                return;
            }

            fetch('EN_submit_review.php', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                .then(result => {
                    if (result.success) {
                        Swal.fire('Review successfully submitted!', '', 'success');
                        $('#reviewModal').modal('hide');
                    } else {
                        Swal.fire('Error sending review: ' + (result.message || 'Please try again.'), '', 'error');
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
                    Swal.fire('Error connecting when sending the review.', '', 'error');
                });
        }

        function openEditReviewModal(reviewId, furnitureName, currentRating, currentComment) {

            document.getElementById('reviewModalLabel').innerHTML = 'Edit Review for <span id="reviewFurnitureName">' + furnitureName + '</span>';
        ...
        function updateReview(reviewId) {
            ...
            fetch('EN_edit_review.php', {
                ...
                .then(result => {
                    if (result.success) {
                        Swal.fire('Review successfully updated!', '', 'success');
                        $('#reviewModal').modal('hide');
                        ...
                        Swal.fire('Error updating review: ' + (result.message || 'Please try again.'), '', 'error');
                    }
                })
                .catch(error => {
                    console.error('Error:', error);
                    Swal.fire('Connection error when updating the review.', '', 'error');
                });
        }
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch('EN_delete_review.php', {
                        ...
                        .then(result => {
                            if (result.success) {
                                Swal.fire('Review deleted!', 'Your review has been deleted.', 'success');
                                ...
                                Swal.fire('Error deleting review: ' + (result.message || 'Try Again'), '', 'error');
                            }
                        })
                        .catch(error => {
                            console.error('Error:', error);
                            Swal.fire('Connection error when deleting the review.', '', 'error');
                        });
                }
            });
        }
        ...
        $('#reviewModal').on('hidden.bs.modal', function() {
            ...
            document.getElementById('reviewModalLabel').innerHTML = 'Add Review for <span id="reviewFurnitureName"></span>';
