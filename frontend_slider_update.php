            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center"><br>
                        <h4 class="page-title">Modificar Slider</h4></br>

                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Modificar Slider</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>";
                                echo "<form method='post' action='backend_slider_update.php'>";
                            ...
                            echo "<tr><td colspan='2'>No hay imagenes disponibles</td></tr>";
                        }
