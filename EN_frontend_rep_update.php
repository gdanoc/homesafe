            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center"><br>
                        <h4 class="page-title">Modify Delivery People</h4></br>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>";
                                echo "<form method='post' action='EN_backend_rep_update.php'>";
                                echo "<div class='propiedad-actions'>";
                                echo "<input type='hidden' name='id' value='" . htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8') . "'>";
                                echo "<button type='submit' class='edit-button'>Update</button>";
                                echo "</div>";
                                echo "</form>";
                                echo "</td>";
                                echo "</tr>";
                            ...
                            echo "<tr><td colspan='6'>There is no delivery people available</td></tr>";
                        }
