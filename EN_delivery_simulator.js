...
class DeliverySimulator {
    ...
    createMarkers() {
        ...
        startMarker.bindPopup('📍 Initial location of the delivery person');
        ...
        endMarker.bindPopup('🏠 Delivery destination');
        ...
        this.deliveryMarker.bindPopup('🚚 Delivery person on the move');
    }
    ...
    handleRouteFound(e) {
        ...
        console.log('Estimated time:', this.estimatedTime, 'seconds');
        ...
        this.updateMessage('📍 Route calculated. Press “Start Delivery” to begin the simulation.');
    }
    ...
    handleRouteError(e) {
        ...
        this.updateMessage('❌ Error calculating route. Check coordinates.');
    }
    ...
    setupEventListeners() {
        ...
        this.map.whenReady(() => {
            console.log('Map ready for simulation');
        });
    }
    ...
    start() {
        ...
        // Actualizar UI
        this.updateMessage('🚚 Simulation started - The delivery person is on their way...');
    ...
    complete() {
        ...
        // Actualizar UI
        this.updateMessage('✅ Simulation complete! The delivery person has arrived at the destination.');
        ...
        this.deliveryMarker.bindPopup('🎉 Arrival at destination! You can complete the delivery.').openPopup();
    ...
    stop() {
        ...
        this.updateMessage('⏹️ Simulation stopped.');
    ...
    pause() {
        ...
        this.updateMessage('⏸️ Slow simulation.');
    ...
    resume() {
        ...
        this.isRunning = true;
        this.updateMessage('▶️ Simulation resumed.');
        this.updateStatus('En camino');
    ...
    updateProgress(progress) {
        ...
        if (progress < 1) {
            this.updateMessage(`🚚 On the way... ${percentage}% completed`);
        }
    ...
    updateETA(seconds) {
        ...
        if (seconds <= 0) {
            this.uiElements.etaElement.textContent = 'Arrival!';
            return;
        }
