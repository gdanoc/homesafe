...
if($_SESSION['email'] == $propiedad['vendedor_email']){
    echo '<p><script>swal({
        title: "Error",
        text: "You cannot buy your own property.",
        icon: "success",
        button: "Close",
    
        }).then(function() {
        window.location = "EN_properties.php";
    });</script></p>';
    exit();
}
    ...
    <div class="page">
                            ...
                            <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                                ...
                                <ul class="rd-navbar-nav">
                                    ...
                                    <li class="rd-nav-item"><a class="rd-nav-link"
                                            href="EN_properties.php">Properties</a>
                                    </li>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if (isset($_SESSION['email'])): ?>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="#" data-bs-toggle="modal" data-bs-target="#PerfilModal"> Current Session: <?php echo htmlspecialchars($username); ?></a>
                                        </li>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="EN_mostrarcarrito.php"><i class="fa fa-shopping-cart" style="font-size: 1.5em;"></i></a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
        ...
        <div class="d-flex justify-content-end" style="max-width:900px;margin:auto;margin-bottom:1.5rem;">
            <button type="button" class="btn btn-success galeria-button" id="openGalleryBtn">
                <i class="fa fa-camera"></i> View more pictures
            </button>
        </div>
        ...
        <div class="main-container">
            ...
            <div class="location-info">
                <strong>Location:</strong> <?php echo htmlspecialchars($direccion); ?><br>
                <strong>Coordinates:</strong> <?php echo number_format($latitud, 6); ?>, <?php echo number_format($longitud, 6); ?><br><br>
                <a href="https://www.google.com/maps?q=<?php echo urlencode($latitud . ',' . $longitud); ?>"
                    ...
                    <i class="fa fa-map-marker-alt me-2"></i> See location on Google Maps
                </a>
            </div>
                ...
                <div class="col-lg-8">
                    <section class="property-main-info bg-white p-4 rounded shadow-sm mb-4">
                        <div class="property-title-container">
                            <h1><?php echo htmlspecialchars(tr($propiedad['nombre'])); ?></h1>
                        ...
                        <div class="property-price">
                            ...
                            <div class="property-specs">
                                <span><b>Size:</b> <?php echo htmlspecialchars($propiedad['size']); ?> m²</span>
                                <span><b>Total Rooms:</b> <?php echo $total_rooms; ?></span>
                            </div>
                        </div>
                    </section>
                    ...
                    <section class="property-description bg-white p-4 rounded shadow-sm mb-4">
                        ...
                        <p><?php echo tr(htmlspecialchars(tr($propiedad['descripcion']))); ?></p>
                    </section>
                    <section class="property-rooms bg-white p-4 rounded shadow-sm mb-4">
                        <h3 class="mb-4">Rooms and Places</h3>
                        <?php if (count($cuartos) > 0): ?>
                            <?php foreach ($cuartos as $cuarto): ?>
                                <div class="room mb-4">
                                    <h4>
                                        <?php echo htmlspecialchars(tr($cuarto['nombre_cuarto'])); ?>
                                        <small style="font-weight: 700; font-size: 1rem; color: #007bff; margin-left: 8px; text-transform: capitalize;">
                                            (<?php echo htmlspecialchars(tr($cuarto['tipo_cuarto'])); ?>)
                                        </small>
                                    </h4>
                                    <p><?php echo nl2br(htmlspecialchars(tr($cuarto['descripcion_cuarto']))); ?></p>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header bg_background text-white" style="padding:1.5rem 2rem 1rem;">
                                                    <h5 class="modal-title" id="roomGalleryModalLabel-<?php echo $cuarto['id']; ?>">
                                                        Photo Gallery - <?php echo htmlspecialchars(tr($cuarto['nombre_cuarto'])); ?>
                                                    </h5>
                            ...
                            <?php else: ?>
                                <p>There are no additional rooms in this property.</p>
                            <?php endif; ?>
                    </section>
                    <section class="property-overview bg-white p-4 rounded shadow-sm mb-4">
                        <h3 class="mb-4">General Vision</h3>
                        <div class="overview-grid">
                            ...
                            <div class="overview-item">
                                <span><b>Bedrooms:</b> <?php echo $total_bedrooms; ?></span>
                            </div>
                            <div class="overview-item">
                                <span><b>Bathrooms:</b> <?php echo $total_bathrooms; ?></span>
                            </div>
                        </div>
                    </section>
                </div>
                    ...
                    <section class="contact-section bg-white p-4 rounded shadow-sm">
                        ...
                        <?php if ($propiedad['estado'] == 'Vendido'): ?>
                            ...
                            <div class="alert alert-warning text-center mb-3">
                                <i class="fa fa-info-circle"></i> This property has already been sold.
                            </div>
                            <button type="button" class="send-message-btn btn btn-secondary btn-block" disabled>
                                <i class="fa fa-ban"></i> Property Sold
                            </button>
                        <?php else: ?>
                            <!-- Formulario normal para propiedades disponibles -->
                            <form class="contact-form" method="post" action="EN_chat_solicitud.php">
                                ...
                                <button type="submit" class="send-message-btn btn btn-primary btn-block">
                                    <i class="fa fa-comments"></i> Request chat
                                </button>
                            </form>
                        <?php endif; ?>
                    </section>
