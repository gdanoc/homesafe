                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Agregar Repartidores<i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Agregar Repartidores</h4>

                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Agregar Nuevo Repartidor</h1>
                <form action="backend_rep_create.php" method="post" enctype="multipart/form-data" id="deliveryForm">
                    <input type="text" name="nombre" class="login-input" placeholder="Nombre del Repartidor" id="nombre" />
                    <div id="nombreError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="text" name="telefono" class="login-input" placeholder="Telefono" id="telefono" />
                    ...
                    <input type="password" name="password" class="login-input" placeholder="Contraseña" id="password" />
                    <div id="passwordError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="password" name="repeat_password" class="login-input" placeholder="Repetir Contraseña" id="repeat_password" />
                    ...
                    <input type="submit" name="submit" value="Agregar" class="login-button" />
                </form>
            </div>
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function validateNombre() {
                        ...
                        if (nombre === '') {
                            showError('nombre', 'El nombre del repartidor es obligatorio');
                            return false;
                        }
                        if (nombre.length < 2) {
                    ...
                    function validateTelefono() {
                        ...
                        if (!telefonoRegex.test(telefono)) {
                            showError('telefono', 'El teléfono debe seguir el formato: 0000-0000');
                            return false;
                        }
                        clearError('telefono');
                        return true;
                    ...
                    function validateEmail() {
                        ...
                        if (email.length < 5) {
                            showError('email', 'El email debe tener al menos 5 caracteres');
                            return false;
                        }
                        if (email.length > 100) {
                            showError('email', 'El email no puede exceder 100 caracteres');
                            return false;
                        }
                    ...
                    function validateEstado() {
                        ...
                        if (estado === '') {
                            showError('estado', 'Por favor seleccione un estado');
                            return false;
                        }
                        clearError('estado');
                        return true;
