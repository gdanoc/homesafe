...
if (!isset($_SESSION['user_id'])) {
    ...
    if (pg_num_rows($result) > 0) {
        ...
        echo '<script>alert("Error: Your account could not be found."); window.location = "EN_index.php";</script>';
        exit();
    }
}
...
<head>
    <title>Shopping Cart - HomeSafe</title>
        ...
        <section class="section novi-background section-md text-center">
            <div class="container">
                <h3 class="text-uppercase font-weight-bold wow-outer">
                    <br>
                    <span class="wow slideInDown">My Shopping Cart</span>
                </h3>
                <div class="row row-lg-50 row-35 offset-top-2">
                    <?php if (count($productos) > 0): ?>
                        <form method="post" action="EN_updatecarrito.php">
                            <div class="row">
                                <div class="col-lg-8">
                                        ...
                                        <div class="cart-item row align-items-center">
                                            <div class="col-md-2">
                                                <img src="data:image/jpeg;base64,<?php echo base64_encode(pg_unescape_bytea($producto['imagen'])); ?>"
                                                    alt="<?php echo htmlspecialchars(tr($producto['nombre'])); ?>" class="img-fluid">
                                            </div>
                                            <div class="col-md-4">
                                                <h5><?php echo htmlspecialchars(tr($producto['nombre'])); ?></h5>
                                                <p class="text-muted">Unit Price: $<?php echo number_format($producto['precio_unitario'], 2); ?></p>
                                    ...
                                    <div class="d-flex flex-column flex-sm-row justify-content-between mt-4 gap-3">
                                        <a href="EN_furniture.php" class="btn btn-outline-secondary w-100 w-sm-auto">
                                ...
                                <div class="col-lg-4">
                                    <div class="cart-summary">
                                        ...
                                        <a href="EN_compra.php" class="btn btn-success btn-checkout">
                                        ...
                                        <div class="mt-3 p-3" style="background-color: #e3f2fd; border-radius: 8px; border-left: 4px solid #2196f3;">
                                            <small class="text-muted">
                                                ...
                                                <strong>Information:</strong> Products are automatically deleted after 18 hours.
                                                When new products are added, the time is reset for all products.
                                            </small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <?php else: ?>
                        <div class="empty-cart">
                            ...
                            <p>It appears that you have not yet added any products to your cart.</p>
                            <a href="EN_furniture.php" class="btn btn-primary mt-3">Go shopping</a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    <script>
        ...
        function updateCartPrices() {
            ...
            if (hasValidProducts) {
                ...
                console.warn('No valid products were found to calculate the total.');
            }
        }
        ...
        function increaseQuantity(inputId, max) {
            ...
            if (currentValue < max) {
                ...
                Swal.fire({
                    ...
                    text: `There are only ${max} units available`,
                    icon: 'warning',
                    timer: 2000,
        ...
        function confirmarEliminacion(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = 'EN_eliminarcarrito.php?id=' + id;
                }
            });
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (missingPriceData) {
                console.error('Some inputs do not have the data-price attribute.');
                debugCartData();
            }
    ...
    <?php if (isset($_GET['update'])): ?>
        <script>
            <?php if ($_GET['update'] == 'success'): ?>
                Swal.fire({
                    title: "Success",
                    text: "It updated <?php echo intval($_GET['count']); ?> product/s in the cart",
                    icon: "success",
                    button: "Close",
                }).then(() => {
