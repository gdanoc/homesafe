                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Agregar Imagen Carrusel<i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Agregar Imagen Carrusel</h4>

                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Agregar Nueva Imagen al Carrusel</h1>
                <form id="carouselForm" action="backend_slider_create.php" method="post" enctype="multipart/form-data">
                    <input type="text" id="nombre" name="nombre" class="login-input"
                        placeholder="Título de la imagen" />
                    <span class="error-message" id="nombreError"></span>

                    <input type="file" id="imagen" name="imagen" class="login-input" accept="image/*" />
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function validarNombre() {
                        ...
                        if (valor === '') {
                            mensajeError = 'El título de la imagen es obligatorio';
                            esValido = false;
                        }
                        
                        else if (valor.length < LIMITES.nombre.min) {
                            mensajeError = `El título debe tener al menos ${LIMITES.nombre.min} caracteres`;
                            esValido = false;
                        }
                        
                        else if (valor.length > LIMITES.nombre.max) {
                            mensajeError = `El título no puede exceder ${LIMITES.nombre.max} caracteres`;
                            esValido = false;
                        }
                            ...
                            mensajeError = 'El título no puede contener solo espacios';
                            esValido = false;
                        }
                        
                        else if (/^\d/.test(valor)) {
                            mensajeError = 'El título no puede comenzar con números';
                            esValido = false;
                        }
                            ...
                            if (!LIMITES.archivo.allowedTypes.includes(archivo.type)) {
                                ...
                                img.onload = function() {
                                    if (this.width < 200 || this.height < 200) {
                                        mostrarError(imagenInput, imagenError, 'La imagen debe ser de al menos 200x200 píxeles', false);
                                    }
                                };
                                img.onerror = function() {
                                    mostrarError(imagenInput, imagenError, 'El archivo seleccionado no es una imagen válida', false);
                                };
