            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center"><br>
                        <h4 class="page-title">Modify Slider</h4></br>

                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Modify Slider</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td><a href='EN_backend_slider_update.php?id=" . $row['id'] . "' class='edit-button'>Modify</a></td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='2'>There are no images in the carousel</td></tr>";
                        }
