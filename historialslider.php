                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Historial Slider <i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Historial Slider</h4>
                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Historial Slider</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Acción</th>
                    ...
                    <tbody>
                        ...
                        try {
                            ...
                            if (pg_num_rows($result) > 0) {
                                while ($row = pg_fetch_assoc($result)) {
                                    ...
                                    if ($row['rebobinado'] === "no") {
                                        if ($row['accion'] === "Eliminar" || $row['accion'] === "Modificar") {
                                            echo "<td><a href='rebobinarslider.php?id=" . $row['id'] . "&accion=" . htmlspecialchars($row['accion']) . "' class='btn-rebobinar'>Rebobinar</a></td>";
                                        } else {
                                            echo "<td></td>";
                                        }
                                    } else {
                                ...
                                echo "<tr><td colspan='8'>No hay registros en el historial.</td></tr>";
                            }
