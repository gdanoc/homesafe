        ...
        <section class="section novi-background section-md text-center">
            <div class="container">
                <h3 class="text-uppercase font-weight-bold wow-outer">
                    <br>
                    <span class="wow slideInDown">My Chats</span>
                </h3>
                                    ...
                                    <div class="chat-summary">
                                        <div class="chat-title">
                                            <h5 class="mb-1">
                                                ...
                                                Chat with: <?php echo htmlspecialchars($chat['user_gmail_other']); ?>
                                            </h5>
                                    ...
                                    <div class="chat-body">
                                        <div class="details-grid">
                                            ...
                                            <div class="detail-item <?php echo ($chat['estado'] == 'f') ? 'detail-item-canceled' : ''; ?>">
                                                ...
                                                <div class="detail-value">
                                                    <?php if ($chat['estado'] == 't'): ?>
                                                        <span class="text-success">✓ Active conversation</span>
                                                    <?php elseif ($chat['estado'] == 'p'): ?>
                                                        <span class="text-warning">⏳ Awaiting seller approval</span>
                                                    <?php elseif ($chat['estado'] == 'f'): ?>
                                                        <span class="text-canceled">❌ Chat Cancelled/Rejected</span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="chat-actions mt-4">
                                            <?php if ($chat['estado'] == 'p'): ?>
                                                ...
                                                <small class="text-muted d-block mt-2">
                                                    The seller must approve your request to start the chat
                                                </small>
                                            <?php elseif ($chat['estado'] == 't'): ?>
                                                <form method="post" action="chatEn/index.php" style="display: inline;">
                                                ...
                                                <small class="text-success d-block mt-2">
                                                    <i class="fas fa-check-circle me-1"></i>
                                                    Chat available - You can chat now!
                                                </small>
                                            <?php elseif ($chat['estado'] == 'f'): ?>
                                                <div class="canceled-actions">
                                                    ...
                                                    <h6 class="text-danger mb-2">Chat unavailable</h6>
                                                    <p class="text-muted mb-3">
                                                        This chat has been canceled or rejected by the seller.
                                                        It is not possible to continue the conversation.
                                                    </p>
                                                    ...
                                                    <div class="alternative-actions">
                                                        <small class="text-muted d-block mb-2">What can you do?</small>
                ...
                <?php else: ?>
                    <div class="empty-chats">
                        ...
                        <p class="text-muted mb-4">When you start a conversation with a salesperson, it will appear here.</p>
