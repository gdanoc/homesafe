    ...
    <div class="chat-container">
        ...
        <div class="chat-input-container">
            <form id="formulario" autocomplete="off" onsubmit="return false;">
                ...
                <input type="text" name="mensaje" placeholder="Type your message..." required autocomplete="off" maxlength="200" /> <button type="submit">
                    <i class="fas fa-paper-plane"></i>
                    <span>Send</span>
                </button>
            </form>
            <form action="comprar.php" method="post" style="margin-left: 1rem;">
                <input type="hidden" name="id_chat" value="<?php echo htmlspecialchars($id_chat); ?>">
                <input type="hidden" name="id_casa" value="<?php echo htmlspecialchars($id_casa); ?>">
                <input type="hidden" name="customer_gmail" value="<?php echo htmlspecialchars($customer_gmail); ?>">
