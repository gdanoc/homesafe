...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Users List</h1>
                ...
                $allowed_sort_fields = ['id', 'username', 'email', 'id_rol'];
                ...
                $query = "SELECT id, username, email, password, id_rol 
                          FROM accounts 
                    ...
                    <div class="pagination-container">
                        ...
                        <ul class="pagination">
                            <?php if ($current_page > 1): ?>
                                <li><a href="?page=1&per_page=<?php echo $records_per_page; ?>&sort=<?php echo $sort_field; ?>&dir=<?php echo $sort_direction; ?>">First</a></li>
                            <?php endif; ?>

                            <?php if ($current_page > 1): ?>
                                <li><a href="?page=<?php echo $current_page - 1; ?>&per_page=<?php echo $records_per_page; ?>&sort=<?php echo $sort_field; ?>&dir=<?php echo $sort_direction; ?>">Previous</a></li>
                            <?php endif; ?>
                            ...
                            <?php if ($current_page < $total_pages): ?>
                                <li><a href="?page=<?php echo $current_page + 1; ?>&per_page=<?php echo $records_per_page; ?>&sort=<?php echo $sort_field; ?>&dir=<?php echo $sort_direction; ?>">Next</a></li>
                            <?php endif; ?>

                            <?php if ($current_page < $total_pages): ?>
                                <li><a href="?page=<?php echo $total_pages; ?>&per_page=<?php echo $records_per_page; ?>&sort=<?php echo $sort_field; ?>&dir=<?php echo $sort_direction; ?>">Last</a></li>
                            <?php endif; ?>
                        </ul>
                        <div></div>
                    </div>
                ...
                <div class="pdf-download">
                    <a href="EN_generar_pdf_usuario.php" class="btn btn-primary" target="_blank">
