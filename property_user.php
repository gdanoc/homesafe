...
<head>
    <title>Mis Propiedades - HomeSafe</title>
        ...
        <section class="section novi-background section-md text-center">
            <div class="container">
                <h3 class="text-uppercase font-weight-bold wow-outer">
                    <br>
                    <span class="wow slideInDown">Mis Propiedades</span>
                </h3>
                                    ...
                                    <div class="chat-summary">
                                        <div class="chat-title">
                                            <h5 class="mb-1">
                                                ...
                                                Propiedad de: <?php echo htmlspecialchars($property['mail_user']); ?>
                                            </h5>
                ...
                <?php else: ?>
                    <div class="empty-chats">
                        ...
                        <h4>No tienes propiedades a tu nombre</h4>
                        <p class="text-muted mb-4">Cuando confirmes la compra con un vendedor, aparecerá aquí.</p>
