<?php
include('0_ENvalidacion_Seller.php'); //ENGLISH 
include('logic_dashboard_vendedor.php');
require_once('0_ENvalidar_suscripcion.php');
...
<head>
    ...
    <title>RealStateAgent CRUD - HomeSafe</title>
    <!-- CSS Libraries -->
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Create Properties<i class="page-tittle"></i></span>
            ...
            <div class="container-fluid">
                <div class="text-center mb-4">
                    <h1 class="display-4 text-primary fw-bold">
                        <i class="fas fa-home me-3"></i> Create New Property
                    </h1>
                    <p class="lead text-muted">Complete the information about this property</p>
                </div>

                <form id="propertyForm" action="EN_backend_create_vendedor.php" method="post" enctype="multipart/form-data">
                    <div class="form-card">
                ...
                <script>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select name="room_types[]" class="form-select">
                                        <option value="Dormitorio">Bedroom</option>
                                        <option value="Sala">Living Room</option>
                                        <option value="Comedor">Dining room</option>
                                        <option value="Cocina">Kitchen</option>
                                        <option value="Baño">Bathroom</option>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        if (userPlanId === 1 || userPlanId === 4) {
                            ...
                            const container = document.getElementById('roomsContainer');
                            container.innerHTML = '<div class="alert alert-warning" role="alert" style="margin-bottom: 15px;">Your HomeSafe Lite plan does not allow modifying or adding rooms and spaces.</div>';
                        } else {
                            addRoom();
                        }
                        initMap();
                    ...
                    document.getElementById('propertyForm').addEventListener('submit', function(e) {
                        ...
                        if (nombre.length > 50) {
                            e.preventDefault();
                            showAlert("Property name cannot exceed 50 characters.");
                            return;
                        }
                        ...
                        if (isNaN(precio) || precio < 1 || precio > 1000000) {
                            e.preventDefault();
                            showAlert("Price must be a number between 1 and 1,000,000.");
                            return;
                        }
                        ...
                        if (isNaN(size) || size < 1 || size > 10000) {
                            e.preventDefault();
                            showAlert("Size must be a number between 1 and 10,000.");
                            return;
                        }
                        ...
                        if (!latitud || !longitud) {
                            e.preventDefault();
                            showAlert("You must select a location on the map.");
                            return;
                        }
                        ...
                        if (mainImages.length === 0) {
                            e.preventDefault();
                            showAlert("You need to select at least one main image.");
                            return;
                        }
                        ...
                        if (userPlanId !== 1 && rooms.length === 0) {
                            e.preventDefault();
                            showAlert("You need to add at least one room.");
                            return;
                        }
                        ...
                        for (let i = 0; i < rooms.length; i++) {
                            ...
                            if (!roomNameInput.value.trim()) {
                                e.preventDefault();
                                showAlert(`Room name #${i + 1} is required.`);
                                return;
                            }
                            if (roomNameInput.value.length > 50) {
                                e.preventDefault();
                                showAlert(`Room name #${i + 1} cannot exceed 50 characters.`);
                                return;
                            }
                        }
                    });
