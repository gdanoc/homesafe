...
<head>
    <title>Favorite Furniture</title>
                        ...
                        <div class="rd-navbar-main">
                            <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                                ...
                                <ul class="rd-navbar-nav">
                                    ...
                                    <?php else: ?>
                                        <li class="rd-nav-item"><a class="rd-nav-link" href="logout.p.php">Log Out</a></li>
    ...
    <section class="section novi-background section-md text-center">
        <div class="container">
            <h3 class="text-uppercase font-weight-bold wow-outer">
                <br>
                <span class="wow slideInDown">My Favorites</span>
            </h3>
...
<div class="col-md-4 col-lg-3 wow-outer" style="padding-top: 8px; padding-bottom: 20px; margin-bottom: 10px;">
    <article class="post-modern wow fadeIn" style="padding: 12px; border: 2px solid #444; border-radius: 10px; text-align: center; max-width: 280px; margin: 0 auto; transition: all 0.3s ease; box-shadow: 0 4px 8px rgba(0,0,0,0.1); position: relative; top: 0;"
        ...
        <p style="font-size: 14px;">Quantity: <?php echo htmlspecialchars($row['cantidad'], ENT_QUOTES, 'UTF-8'); ?></p>
...
<?php }
                    ...
                    echo '<div class="col-12 text-center py-5"><h4>There are no favorite furniture</h4></div>';
                }
                pg_close($conn);
                ?>
            </div>
...
function addToCart(id, quantity, availableQuantity) {
    ...
    if (quantity > availableQuantity) {
        swal("You cannot add more units than are available.", "", "warning");
        return;
    }
...
function noStockAlert() {
    swal("You cannot add this product to your cart because there are no more units available.", "", "warning");
}
