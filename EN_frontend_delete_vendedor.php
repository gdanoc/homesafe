<?php include('0_ENvalidacion_Seller.php'); //ESPAÑOL 

?>
<?php include('logic_dashboard_vendedor.php'); ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>CRUD Real State Agent - HomeSafe</title>
    <!-- Custom CSS -->
    <link href="assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="dist/css/style.min.css" rel="stylesheet">

    <!-- SweetAlert CSS - AÑADIDO -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11/dist/sweetalert2.min.css">
    <!-- SweetAlert JS - AÑADIDO -->
    ...
    <style>
        ...
        * {
        ...
        .delete-button:hover {
            background-color: rgb(53, 96, 126);
        }
    </style>
</head>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Delete Properties<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center"><br>

                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Delete Properties</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        $query = "SELECT id, nombre, descripcion, bathrooms, bedrooms, size, precio, fecha, mail_user FROM propiedades WHERE mail_user = $1";
                        ...
                        if (pg_num_rows($result) > 0) {
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>";
                                echo "<form method='post' action='EN_backend_delete_vendedor.php'>";
                                echo "<div class='propiedad-actions'>";
                                echo "<input type='hidden' name='id' value='" . htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8') . "'>";
                                echo "<button type='button' class='delete-button' onclick='confirmDelete(this.form)'>Delete</button>";
                                echo "</div>";
                                echo "</form>";
                                echo "</td>";
                                echo "</tr>";
                            ...
                            echo "<tr><td colspan='9' style='text-align: center;'>No properties for this seller</td></tr>";
                        }
                            ...
                            function confirmDelete(formElement) {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({
                                            text: "The property has not been deleted",
                                            icon: "warning"
                                        })
                                    }
                                });
