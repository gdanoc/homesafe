...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['cambiar_repartidor'])) {
    ...
    try {
        ...
        $mensaje_usuario = "Tu orden #$pedido_id ha sido asignada a " . $info_repartidor['nombre'] . ".";
        ...
        $mensaje = "Repartidor cambiado para el pedido #$pedido_id";
        $tipo = "success";
    } catch (Exception $e) {
...
<head>
    ...
    <title>Cambiar Repartidor - HomeSafe</title>
            ...
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4>Cambiar Repartidor - Pedido #<?php echo $pedido_id; ?></h4>
                    </div>
                    <div class="card-body">
                        <?php if (!isset($pedido)): ?>
                        ...
                        <?php else: ?>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <p><strong>Dirección del Envío:</strong> <?php echo $pedido['direccion_entrega']; ?></p>
                                </div>
                                <div class="col-md-6">
                                    <p><strong>Total:</strong> $<?php echo number_format($pedido['total'], 2); ?></p>
                                    <?php if ($repartidor_actual): ?>
                                        <p><strong>Repartidor Actual:</strong> <?php echo $repartidor_actual['nombre_repartidor']; ?></p>
                                    <?php else: ?>
                                        <p><strong>Repartidor Actual:</strong> No asignado</p>
                                    <?php endif; ?>
                                </div>
                            </div>

                            <form method="post" action="cambiar_repartidor.php">
                                ...
                                <div class="mb-3">
                                    <label for="repartidor_id" class="form-label">Seleccionar un nuevo repartidor:</label>
                                    <select name="repartidor_id" id="repartidor_id" class="form-select" required>
                                        <option value="">-- Seleccionar un repartidor --</option>
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                    ...
                                    <button type="submit" name="cambiar_repartidor" class="btn btn-primary">Cambiar Repartidor</button>
                                </div>
                            </form>
                        <?php endif; ?>
                    </div>
