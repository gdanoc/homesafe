...
<head>
    ...
    <title>Eliminar Slider - HomeSafe</title>
    <!-- Custom CSS -->
    <link href="assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="dist/css/style.min.css" rel="stylesheet">
    <!-- SweetAlert2 (asegúrate de que esta es la versión que quieres usar) -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <!-- Si prefieres la versión de unpkg que usabas antes, cámbiala:
...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Eliminar Carrusel<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <div class="form">
                <h1 class="login-title">Eliminar Imagen</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<form method='post' action='backend_slider_delete.php'>";
                            ...
                            echo "<tr><td colspan='3'>No hay imagenes disponibles</td></tr>"; 
                        }
                            ...
                            function confirmDelete(formElement) {
                                Swal.fire({ 
                                    ...
                                    if (result.isConfirmed) {
                                        ...
                                        Swal.fire({ 
                                            text: "La imagen no se ha eliminado",
                                            icon: "warning"
                                        });
                                    }
                                });
