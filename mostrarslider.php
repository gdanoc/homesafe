...
<head>
    ...
    <title>Vista Slider - HomeSafe</title>
    <!-- Custom CSS -->
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Carrusel de Imagenes <i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Carrusel de Imagenes</h4>
                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Lista de Imagenes Carrusel</h1>
                <table>
                    ...
                    <tbody>
                        ...
                        $query = "SELECT nombre, imagen FROM slider";
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td><img src='data:image/*;base64," . base64_encode($imagen_data) . "' width='100' height='100'/></td>";
                                echo "</tr>";
                            }
                        } else {
                            echo "<tr><td colspan='4'>No hay imagenes disponibles</td></tr>";
                        }
