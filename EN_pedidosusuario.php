...
<head>
    <title>My Orders - HomeSafe</title>
        ...
        <section class="section novi-background section-md text-center">
            <div class="container">
                <h3 class="text-uppercase font-weight-bold wow-outer">
                    <br>
                    <span class="wow slideInDown">My Orders</span>
                </h3>
                                    ...
                                    <div class="order-body">
                                        ...
                                        <?php if ($pedido['estado'] == 'listo' || $pedido['estado'] == 'entregado'): ?>
                                            <?php if ($pedido['repartidor']): ?>
                                                <div class="delivery-tracking">
                                                    <h6 class="mb-3"><i class="fas fa-truck me-2"></i> Tracking</h6>
                                                    ...
                                                    <div class="tracking-steps">
                                                        <div class="tracking-step <?php echo ($pedido['estado'] == 'listo' || $pedido['estado'] == 'entregado') ? 'active' : ''; ?>">
                                                            <div class="tracking-label">Order assigned to delivery person</div>
                                                        ...
                                                        <div class="tracking-step <?php echo ($pedido['repartidor']['estado_entrega'] == 'en_camino' || $pedido['estado'] == 'entregado') ? 'active' : ''; ?>">
                                                            <div class="tracking-label">On the way</div>
                                                ...
                                                <?php if ($pedido['estado'] == 'listo' || $pedido['estado'] == 'pendiente'):    ?>
                                                    <form method="post" action="chatEn/chat_repartidor/cus.php" style="display: inline;">
                                                    ...
                                                    <div class="delivery-map-container">
                                                        <div class="map-info">
                                                            ...
                                                            <div class="route-info">
                                                                ...
                                                                <span><i class="fas fa-truck" style="color: #0056b3;"></i> Delivery Person</span>
                                                            </div>
                                            ...
                                            <?php else: ?>
                                                <div class="alert alert-info">
                                                    <i class="fas fa-info-circle me-2"></i> Your order is ready and will be assigned to a delivery person soon.
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                        ...
                                        <div class="products-section mt-4">
                                            <h6 class="mb-3">
                                                ...
                                                Products (<?php echo count($pedido['detalles']); ?>)
                                            </h6>
                ...
                <?php else: ?>
                    <div class="empty-orders">
                        ...
                        <p class="text-muted mb-4">When you make a purchase, you can view your order history here.</p>
                        <a href="EN_furniture.php" class="btn btn-primary btn-lg">
                            Go to buy
                        </a>
                    </div>
                <?php endif; ?>
    ...
    <script>
        ...
        function toggleDeliveryMap(pedidoId) {
            ...
            if (visibleMaps[pedidoId]) {
                ...
                button.innerHTML = '<i class="fas fa-eye"></i> View Map';
        ...
        function initializeDeliveryMap(pedidoId) {
            ...
            if (!pedido || !pedido.repartidor || !pedido.repartidor.latitud_repartidor || !pedido.repartidor.longitud_repartidor) {
                console.error('Order or delivery data not found');
                return;
            }
