                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Add Images to Carousel<i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add Image to Carousel</h4>

                    </div>
                </div>
            </div>
            <div class="form">
    <h1 class="login-title">Add Image to Carousel</h1>
    <form action="EN_backend_slider_create.php" method="post" enctype="multipart/form-data">
        <input type="text" name="nombre" class="login-input" placeholder="Image Tittle" required />
        <input type="file" name="imagen" class="login-input" accept="image/*" required />
