...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Properties<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Properties</h1>
                <table>
                    ...
                    <tbody>
                        ...
                        $query = "SELECT id, nombre, descripcion, size, precio, fecha, imagen, mail_user FROM propiedades";
                        $result = pg_query($conn, $query);
                        ...
                        if (pg_num_rows($result) > 0) {
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<tr>";
                                echo "<td>" . htmlspecialchars(tr($row['nombre']), ENT_QUOTES, 'UTF-8') . "</td>";
                                echo "<td>" . htmlspecialchars(tr($row['descripcion']), ENT_QUOTES, 'UTF-8') . "</td>";
                            ...
                            echo "<tr><td colspan='7' style='text-align: center;'>There are no properties</td></tr>";
                        }
                ...
                <div class="pagination-container">
                    <div class="records-info">
                        ...
                        of <?php echo $total_records; ?> registers
                    </div>
            ...
            <div class="pdf-download">
                <a href="EN_generar_pdf_propiedades.php" class="btn btn-primary" target="_blank">
                    <i class="fas fa-file-pdf"></i> Download Properties PDF
                </a>
            </div>
