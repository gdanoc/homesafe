                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Repartidores<i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Lista de Repartidores</h4>
                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Lista de Repartidores</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody>
                        ...
                        if ($result && pg_num_rows($result) > 0) {
                            ...
                            echo "<tr><td colspan='5'>No hay repartidores disponibles</td></tr>";
                        }
