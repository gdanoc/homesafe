...
<head>
    ...
    <title>View Delivery People</title>
    <!-- Custom CSS -->
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Delivery People<i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Delivery People List</h4>
                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Delivery People List</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
...
$query = "SELECT nombre, telefono, email, estado, fecha_registro FROM repartidores";
...
if ($result && pg_num_rows($result) > 0) {
    ...
    while ($row = pg_fetch_assoc($result)) {
        ...
        echo "<td>" . tr(htmlspecialchars($row['estado'])) . "</td>";
        echo "<td>" . htmlspecialchars($row['fecha_registro']) . "</td>";
    }
} else {
    echo "<tr><td colspan='5'>No available delivery people</td></tr>";
}
