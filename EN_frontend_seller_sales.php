...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Orders List</h1>
                <div style="overflow-x: auto;">
                    <table>
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM propiedades WHERE mail_user = $1 and estado = 'Vendido'";
                            ...
                            if (pg_num_rows($result) > 0) {
                                while ($row = pg_fetch_assoc($result)) {
                                    $query2 = "SELECT * FROM sales_seller WHERE id_propiedad = $1";
                                    $result2 = pg_query_params($conn, $query2, array($row['id']));
                                    ...
                                    if ($imagenData !== null) {
                                        ...
                                        echo "<td>There is no image</td>";
                                    }
                                    echo "<td>" . htmlspecialchars($row['estado']) . "</td>";
                                    echo "<td>" . htmlspecialchars($row2['comprador']) . "</td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='7' style='padding: 20px; text-align: center; background-color: #f8d7da; color: #721c24; border-radius: 8px; border: 1px solid #f5c6cb;'>You don't have any property registered.</td></tr>";
                            }
                    ...
                    <div class="pdf-download">
                        <a href="EN_generar_pdf_seller.php" class="btn btn-primary" target="_blank">
                            <i class="fas fa-file-pdf"></i> Download PDF of the Orders
                        </a>
                    </div>
                </div>
            </div>
