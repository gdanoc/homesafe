                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Agregar Muebles<i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Agregar Muebles</h4>

                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Agregar Nuevo Mueble</h1>
                <form action="backend_create.php" method="post" enctype="multipart/form-data" id="furnitureForm">
                    <input type="text" id="nombre" name="nombre" class="login-input" placeholder="Nombre del Mueble" />
                    <div id="nombreError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="text" id="descripcion" name="descripcion" class="login-input" placeholder="Descripción" />
                    <div id="descripcionError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="number" id="precio" name="precio" class="login-input" placeholder="Precio" />
                    <div id="precioError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="number" id="cantidad" name="cantidad" class="login-input" placeholder="Cantidad" />
                    <div id="cantidadError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="number" id="descuento" name="descuento" class="login-input" placeholder="Descuento (%) - Opcional" min="0" max="100" step="0.01" />
                    ...
                    <input type="submit" name="submit_button" value="Agregar" class="login-button" />
                </form>
            </div>
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function validateNombre() {
                        ...
                        if (nombre === '') {
                            showError('nombre', 'El nombre del mueble es obligatorio');
                            return false;
                        }
                        if (nombre.length < 2) {
                        ...
                        if (!nombreRegex.test(nombre)) {
                            showError('nombre', 'El nombre contiene caracteres no válidos');
                            return false;
                        }
                        clearError('nombre');
                        return true;
                    ...
                    function validatePrecio() {
                        ...
                        if (precioNum > 99999.99) {
                            showError('precio', 'El precio no puede exceder $99,999.99');
                            return false;
                        }
                        
                        if (precio.includes('.') && precio.split('.')[1].length > 2) {
                            showError('precio', 'El precio no puede tener más de 2 decimales');
                            return false;
                        }
                        clearError('precio');
                        return true;
                    ...
                    function validateCantidad() {
                        ...
                        if (isNaN(cantidadNum)) {
                            showError('cantidad', 'La cantidad debe ser un número válido');
                            return false;
                        }
                        if (cantidadNum < 1) {
                            showError('cantidad', 'La cantidad debe ser al menos 1');
                            return false;
                        }
                        if (cantidadNum > 100000) {
                            showError('cantidad', 'La cantidad no puede exceder 100,000');
                            return false;
                        }
                        
                        if (cantidad.includes('.')) {
                            showError('cantidad', 'La cantidad debe ser un número entero');
                            return false;
                        }
                        clearError('cantidad');
                        return true;
                    ...
                    function validateDescuento() {
                        ...
                        if (isNaN(descuentoNum) || descuentoNum < 0 || descuentoNum > 100) {
                            showError('descuento', 'El descuento debe ser un número entre 0 y 100');
                            return false;
                        }
                        clearError('descuento');
                        return true;
                    ...
                    function validateImagen() {
                        ...
                        if (!tiposPermitidos.includes(archivo.type)) {
                            showError('imagen', 'Solo se permiten archivos de imagen (JPG, PNG, GIF, WEBP)');
                            return false;
                        }
