...
<head>
    ...
    <title>Orders Delivered - HomeSafe</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Orders Delivered<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Orders Delivered</h1>
                <table>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            ...
                            echo "<tr><td colspan='9' style='text-align:center;'>No orders available</td></tr>";
                        }
                        ?>
                    </tbody>
...
<!-- Controles de Paginación -->
            ...
            <div class="pdf-download">
                <a href="EN_generar_pdf_entregados.php" class="btn btn-primary" target="_blank">
                    <i class="fas fa-file-pdf"></i> Download PDF of Orders Delivered
                </a>
            </div>

            <?php include('includes/homechatEn.php'); ?>
