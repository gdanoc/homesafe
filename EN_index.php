                            ...
                            <div class="rd-navbar-collapse">
                                ...
                                <div class="rd-navbar-collapse-content" id="rd-navbar-collapse-content-1">
                                    ...
                                    <select id="language" name="language" class="language-select" onchange="changeLanguage()">
                                        ...
                                        <option value="es" <?php if ($currentLang == 'es') echo 'selected'; ?>>Spanish</option>
                        ...
                        <div class="rd-navbar-main">
                            <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                                ...
                                <ul class="rd-navbar-nav">
                                    <li class="rd-nav-item active"><a class="rd-nav-link" href="EN_index.php">Home</a></li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="EN_properties.php">Properties</a></li>
                                    <li class="rd-nav-item"><a class="rd-nav-link" href="EN_furniture.php">Furniture</a></li>
                            ...
                            <div class="jumbotron-classic-content">
                                <div class="wow-outer">
                                    <div class="title-docor-text font-weight-bold title-decorated text-uppercase wow slideInLeft text-white">
                                        There are no available sliders
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-6 col-lg-4 wow-outer">
                        ...
                        <article class="box-minimal">
                            ...
                            <div class="box-minimal-main wow-outer">
                                <h4 class="box-minimal-title wow slideInDown">Centralized and accessible platform:</h4>
                                <p class="wow fadeInUpSmall"> HomeSafe brings together a variety of properties in one place, allowing users to easily explore options without having to search multiple sources...</p>
                            </div>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-4 wow-outer">
                        ...
                        <article class="box-minimal">
                            ...
                            <div class="box-minimal-main wow-outer">
                                <h4 class="box-minimal-title wow slideInDown" data-wow-delay=".1s">Interaction between sellers and buyers:
                                </h4>
                                <p class="wow fadeInUpSmall" data-wow-delay=".1s">The ability to contact other sellers directly facilitates quick and efficient negotiations.</p>
                            </div>
                        </article>
                    </div>
                    <div class="col-sm-6 col-lg-4 wow-outer">
                        ...
                        <article class="box-minimal">
                            ...
                            <div class="box-minimal-main wow-outer">
                                <h4 class="box-minimal-title wow slideInDown" data-wow-delay=".2s">Growth and monetization potential:</h4>
                                <p class="wow fadeInUpSmall" data-wow-delay=".2s">The site can be scaled up in the future, integrating features such as advertising or advanced tools for sellers, making it a profitable business in the long term.</p>
                            </div>
                        </article>
                    </div>
                </div>
