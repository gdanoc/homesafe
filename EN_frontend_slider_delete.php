...
<head>
    ...
    <title>Delete Slider - HomeSafe</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                             <span class="d-none d-md-block">Delete Image from the Carousel<i class="page-tittle"></i></span>
        ...
        <div class="page-wrapper">
            ...
            <!-- ============================================================== -->
            <div class="form">
        <h1 class="login-title">Delete Image</h1>
        <table>
            <thead>
                <tr>
                    <th>Name</th>
...
if (pg_num_rows($result) > 0) {
    ...
    echo "<tr><td colspan='2'>There are no images</td></tr>";
}
                    ...
                    function confirmDelete(id) {
                        swal({
                            ...
                            if (willDelete) {
                                ...
                                window.location.href = 'EN_backend_slider_delete.php?id=' + id;
                            } else {
                                swal("The image have not deleted.");
                            }
                        });
                    }
                </script>
