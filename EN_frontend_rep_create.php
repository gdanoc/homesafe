                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-none d-md-block">Add delivery people<i class="page-tittle"></i></span>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Add delivery people</h4>

                    </div>
                </div>
            </div>
            <div class="form">
                <h1 class="login-title">Add new delivery person</h1>
                <form action="EN_backend_rep_create.php" method="post" enctype="multipart/form-data" id="deliveryForm">
                    <input type="text" name="nombre" class="login-input" placeholder="Delivery Person name" id="nombre" />
                    <div id="nombreError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="text" name="telefono" class="login-input" placeholder="Telephone" id="telefono" />
                    <div id="telefonoError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="email" name="email" class="login-input" placeholder="Email" id="email" />
                    <div id="emailError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="password" name="password" class="login-input" placeholder="Password" id="password" />
                    <div id="passwordError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>

                    <input type="password" name="repeat_password" class="login-input" placeholder="Repeat Password" id="repeat_password" />
                    <div id="repeatPasswordError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>
                    ...
                    <select id="estado" name="estado" class="form-select">
                        ...
                        <option value="Inactivo">Disabled</option>
                    </select>
                    <div id="estadoError" class="error-message" style="color: red; font-size: 12px; display: none;"></div>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    function validatePassword() {
                        ...
                        if (password.length < 6) {
                            showError('password', 'The password must be 6 characters at least');
                            return false;
                        }
                        clearError('password');
                        return true;
                    ...
                    function validateRepeatPassword() {
                        ...
                        if (repeatPassword !== password) {
                            showError('repeatPassword', 'LThe password dont match');
                            return false;
                        }
                    ...
                    if (isNombreValid && isTelefonoValid && isEmailValid && isEstadoValid && isPasswordValid && isRepeatPasswordValid) {
                        form.submit();
                    } else {
                    ...
                    function validateNombre() {
                        ...
                        if (nombre === '') {
                            showError('nombre', 'Delivery person name is required');
                            return false;
                        }
                        if (nombre.length < 2) {
                            showError('nombre', 'Delivery person name must have 2 characters at least');
                            return false;
                        }
                        if (nombre.length > 50) {
                            showError('nombre', 'Delivery person name cant be more than 50 characters');
                            return false;
                        }
                        if (!nombreRegex.test(nombre)) {
                            showError('nombre', 'The name only can have letters, numbers and spaces');
                            return false;
                        }
                        clearError('nombre');
                        return true;
                    ...
                    function validateTelefono() {
                        ...
                        if (telefono === '') {
                            showError('telefono', 'Telephone number is required');
                            return false;
                        }
                        if (!telefonoRegex.test(telefono)) {
                            showError('telefono', 'Telephone number must be: 0000-0000');
                            return false;
                        }
                        clearError('telefono');
                        return true;
                    ...
                    function validateEmail() {
                        ...
                        if (email.length < 5) {
                            showError('email', 'The email must be at least 5 characters long.');
                            return false;
                        }
                        if (email.length > 100) {
                            showError('email', 'The email cannot exceed 100 characters.');
                            return false;
                        }
                    ...
                    function validateEstado() {
                        ...
                        if (estado === '') {
                            showError('estado', 'Please select a status');
                            return false;
                        }
                        clearError('estado');
                        return true;
                    ...
                    form.addEventListener('submit', function(e) {
                        ...
                        if (isNombreValid && isTelefonoValid && isEmailValid && isEstadoValid) {
