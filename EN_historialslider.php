...
<body>
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Slider History <i class="page-tittle"></i></span>
    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Slider History</h4>
            </div>
        </div>
    </div>
    <div class="form">
    <h1 class="login-title">Slider History</h1>
    <table>
        <thead>
            <tr>
                <th>Action</th>
    ...
    try {
        ...
        $query = "SELECT * FROM registroslider";
        ...
        if (pg_num_rows($result) > 0) {
            while ($row = pg_fetch_assoc($result)) {
                echo "<tr>";
                echo "<td>" . tr(htmlspecialchars($row['accion'])) . "</td>";
                echo "<td>" . tr(htmlspecialchars($row['nombre'])) . "</td>";
                ...
                if ($row['accion'] === "Agregado" || $row['accion'] === "Eliminar") {
                    echo "<td>There is no previous data</td>";
                    echo "<td>No previous image</td>";
                } else {
                    
                    if (!empty($row['nombre_anterior'])) {
                        echo "<td>" . tr(htmlspecialchars($row['nombre_anterior'])) . "</td>";
                    } else {
                ...
                if ($row['rebobinado'] === "no"){
                    if ($row['accion'] === "Eliminar" || $row['accion'] === "Modificar") {
                        echo "<td><a href='EN_rebobinarslider.php?id=" . $row['id'] . "&accion=" . htmlspecialchars($row['accion']) . "' class='btn-rebobinar'>Rewind</a></td>";
                    } else {
                        echo "<td></td>";
                    }
                } else{
                    echo "<td>Already rewound</td>";
                }
                
                echo "</tr>";
            }
        } else {
            echo "<tr><td colspan='8'>No records in the history.</td></tr>";
        }
