<?php include('0_ENvalidacion_Seller.php'); //ENGLISH 
...
<head>
    ...
    <title>Seller CRUD - HomeSafe</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                ...
                                <span class="d-none d-md-block">Update Properties<i class="page-tittle"></i></span>
                            </a>
                        </li>
                    </ul>
                    <!-- ============================================================== -->
        ...
        <div class="page-wrapper">
            ...
            <div class="form">
                <h1 class="login-title">Update Properties</h1>
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
                    ...
                    <tbody>
                        ...
                        if (pg_num_rows($result) > 0) {
                            while ($row = pg_fetch_assoc($result)) {
                                ...
                                echo "<td>";
                                echo "<form method='post' action='EN_backend_update_vendedor.php'>";
                                echo "<div class='propiedad-actions'>";
                                echo "<input type='hidden' name='id_casa' value='" . htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8') . "'>";
                            ...
                            echo "<tr><td colspan='7' style='text-align: center;'>No properties available for this seller</td></tr>";
                        }
            ...
            <script>
                ...
                document.getElementById('mainImages')?.addEventListener('change', function(e) {
                    ...
                    <button type="button" class="remove-image" title="Remove image" onclick="removeMainImage(${index})">
