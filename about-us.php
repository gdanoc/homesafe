                        ...
                        <div class="rd-navbar-main">
                            <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                                ...
                                <ul class="rd-navbar-nav">
                                    ...
                                    <li class="rd-nav-item active"><a class="rd-nav-link" href="about-us.php">Sobre nosotros</a>
                                    </li>
            ...
            <div class="container">
                <div class="row row-50 justify-content-center justify-content-lg-between flex-lg-row-reverse">
                    <div class="col-md-10 col-lg-6 col-xl-5">
                        ...
                        <p class="about-subtitle">HomeSafe es una tienda virtual donde se pueden comprar propiedades contactando con los agentes inmobiliarios y también se puede encontrar la sección de muebles, como sillas, sofás, mesas, etc.</p>
                        <p>El equipo ofrece un entorno web fácil de usar que permite acceder a las distintas secciones sin problemas. El proyecto tendrá los objetivos, la justificación, una descripción del proyecto, un diagrama de flujo e información adicional.</p>
                    </div>
                    ...
                    <div class="col-md-10 col-lg-4 wow-outer">
                        ...
                        <article class="profile-creative wow slideInLeft">
                            ...
                            <div class="profile-creative-main">
                                ...
                                <p class="profile-creative-position">Desarrollador de Backend y Frontend</p>
                            </div>
                        </article>
                    </div>
                    <div class="col-md-10 col-lg-4 wow-outer">
                        ...
                        <article class="profile-creative wow slideInLeft" data-wow-delay=".2s">
                            ...
                            <div class="profile-creative-main">
                                ...
                                <p class="profile-creative-position">Desarrollador de Backend</p>
                            </div>
                        </article>
                    </div>
                    <div class="col-md-10 col-lg-4 wow-outer">
